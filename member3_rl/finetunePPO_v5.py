...
FT_BEST_PATH = os.path.join(MODEL_DIR, "ppo_platform_agent_finetuned_v5_best.pth")
FT_FINAL_PATH = os.path.join(MODEL_DIR, "ppo_platform_agent_finetuned_v5_final.pth")
...
def finetune():
    ...
    print("=" * 65)
    print("  PPO FINE-TUNE ROUND 5: ENEMY-AVOIDANCE SHAPING (from v3_best)")
    print("=" * 65)
